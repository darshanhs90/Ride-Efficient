...
(function() {
  ...
  config = {
    application: '16fd9e2e-6003-43c0-a83c-d5aa9b501eec', // Fill in your app id here!
    redirect_uri: 'http://localhost:1337/index.html', // Fill in your redirect uri here! (Ex.'http://localhost:63342/myFirstMojioApp/index.html')
    hostname: 'api.moj.io',
    version: 'v1',
    port: '443',
    scheme: 'https'
